...
/* static char SCCSid[] = "@(#)data.h 11.1 5/7/96 Copyright (c) 1991-1996 Varian Assoc.,Inc. All Rights Reserved"; */
/*
...
/* Bits 11-13:  bits 14 and 15 are currently unused */
#define NI2_PHMODE	0x800	/* 1 = ph mode	*/
#define NI2_AVMODE	0x1000	/* 1 = av mode	*/
#define NI2_PWRMODE	0x2000	/* 1 = pwr mode	*/

#define NP_DSPLY	(NP_PHMODE  |  NP_AVMODE  |  NP_PWRMODE)
#define NI_DSPLY	(NI_PHMODE  |  NI_AVMODE  |  NI_PWRMODE)
#define NI2_DSPLY	(NI2_PHMODE |  NI2_AVMODE |  NI2_PWRMODE)

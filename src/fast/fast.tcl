...
TitleFrame $w.f.opts.b.f -text "Output" -relief groove 
...
FileEntry $advf.means -textvariable vars(means) -label "Use file of initial tissue-type means" -title "Select a file of initial tissue-type means" -width 30 -filedialog directory  -filetypes * 

...
int fmrib_main(int argc, char *argv[], short output_dt)
{
  ...
  {    
    ...
    /***************************************************************/
      ...
      i++;
      if (isNumber(string(argv[i]),atof(argv[i]))) input_volume+=(T)atof(argv[i]); 
    ...
    /***************************************************************/
      ...
      i++;
      if (isNumber(string(argv[i]),atof(argv[i]))) 
      {
    ...
    /***************************************************************/
      ...
      i++;
      if (isNumber(string(argv[i]),atof(argv[i]))) {if (atof(argv[i])!=0) input_volume/=(T)atof(argv[i]);}
      else if (FslFileExists(argv[i])) 
      {  
        read_volume4D(temp_volume,string(argv[i]));
        for(int t=0;t<input_volume.tsize();t++)      
    ...
    else if (string(argv[i])=="-max" || string(argv[i])=="-min")
    {
      ...
      i++;
      if (isNumber(string(argv[i]),atof(argv[i]))) param=(T)atof(argv[i]);
      else if (FslFileExists(argv[i])) 
      {                           
	read_volume4D(temp_volume,string(argv[i]));
        file=true;
